...
\begin{abstract}
\textbf{Introduction} Patients with liver cancer are only curatively treated by
...
\vskip1em
\textbf{Methods} The reconstruction of the liver is done in two steps. First,
...
resection shape which respects the safety margin around the tumor. An experiment
to evaluate the accuracy of the reconstructed surface was done on a liver
phantom. A usability test was conducted with three surgeons to evaluate the
software applicability in the operating room. 
\vskip1em
\textbf{Results} The accuracy of the 
\textbf{Conclusions} 
